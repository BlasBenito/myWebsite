...
```{r, echo=FALSE, fig.show='hide' , message=FALSE, warning=FALSE, fig.width=6, fig.height=5.5}
...
```{r, fig.show='hide' , echo = FALSE, fig.width=10, fig.height=14}
plot_training_df(
  data = plant_richness_df,
...
```{r, fig.show='hide' , echo = FALSE, fig.width=10, fig.height=5}
...
```{r, fig.show='hide' , fig.width=8, fig.height=4}
...
```{r, fig.show='hide' , fig.width = 12, fig.height=7.5}
...
```{r, fig.show='hide' , fig.height = 3.2, fig.width=4.5}
...
```{r, fig.show='hide' , fig.width = 6, fig.height=4.5}
...
```{r, fig.show='hide' , fig.width=6, fig.height=3, message=FALSE, warning=FALSE}
...
```{r, fig.show='hide' , fig.width=10, fig.height=4.5}
p1 <- plot_importance(
  model.non.spatial, 
  verbose = FALSE) + 
...
```{r, fig.show='hide' , echo=FALSE, fig.width=12, fig.height=7}
...
```{r, fig.show='hide' , echo=FALSE, fig.width=6, fig.height=4}
...
```{r, fig.show='hide' , fig.width=6, fig.height=5}
