...
- Code Optimization
subtitle: ''
summary: "The first post in a trilogy on code optimization, establishing the foundational principles and decision framework for when and how to optimize code."
authors: [admin]
...
There's four main code features we can tweak to improve (or screw up!) efficiency: the **programming language** we choose, how **simple and readable** our code is, the **algorithm design and data structures** we use, and how well we exploit **hardware utilization** (vectorization, parallelization, memory management, and all that jazz). We'll dive deep into each of these in the next articles of this trilogy.
...
In the [next article](../R-code-optimization-design-readability/) we'll dig into programming languages (compiled vs interpreted), code simplicity, and algorithm design. See you there!
