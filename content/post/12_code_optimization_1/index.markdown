...
## Three Posts on Code Optimization
...
In the next article we'll dig into programming languages (compiled vs interpreted), code simplicity, and algorithm design. See you there!
